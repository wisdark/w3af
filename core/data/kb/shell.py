...
class shell(vuln, exploitResult):
    ...
    def _payload(self, payload_name, parameters):
        ...
        if payload_name in payload_handler.runnable_payloads(self, self.threadpool):
    ...
    def _print_runnable_payloads(self):
        ...
        '''
        payloads = payload_handler.runnable_payloads( self, self.threadpool )
        payloads.sort()
        return '\n'.join( payloads )
    ...
    def end( self ):
        ...
        @return: None
        '''
        msg = 'You should implement the getName method of classes that inherit'
        msg += ' from "shell"'
    ...
    def __repr__( self ):
        ...
        return fmt % (self.getName(),self.getRemoteUser(),self.getRemoteSystem())
